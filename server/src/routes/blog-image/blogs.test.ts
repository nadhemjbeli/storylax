    ...
    tunisianBlogs.forEach((blogData) => {
        ...
        test(`should create blog titled "${blogData.title}" and associate tags`, async () => {
            const blogResponse = await request(app)
                ...
                .field('subtitle', blogData.subtitle)
                .field('resume', blogData.excerpt)
            ...
            expect(blogResponse.body.subtitle).toBe(blogData.subtitle);
            expect(blogResponse.body.excerpt).toBe(blogData.excerpt);
            // expect(blogResponse.body.city).toBe(blogData.city);
            // expect(blogResponse.body.image).toBe(blogData.image);
