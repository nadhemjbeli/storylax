// src/ui/host/features/hotel/screens/hotels/hotels.screen.tsx

import React, { useEffect, useState } from 'react';
import HotelTable from '../../components/hotels-table/hotels-table.component.tsx';
import './hotels.style.scss';
import {getHotelsByHost, IHotel} from '../../../../../../data/hotel/hotel.data.ts';
    ...
    return (
        <div className="admin-hotels-page">
            <div className={"title-wrapper"}>
                <h2>Manage My Hotels</h2>
                <div className="buttons-wrapper">
                    <Link to={"/host/add-hotel"}>
