...
const HostHotelBookingsTable: React.FC<HotelBookingsTableProps> = ({ bookings, onDelete, itemsPerPage = 10 }) => {
    ...
    const sortedBookings = [...filteredBookings].sort((a, b) => {
        ...
        } else if (sortConfig.column === 'client') {
            comparison = `${a.user?.firstName} ${a.user?.lastName}`.localeCompare(`${a.user?.firstName} ${a.user?.lastName}`);
    ...
    return (
        <div className="hotel-bookings-table-container">
            ...
            <table className="hotel-bookings-table">
                <thead>
                <tr>
                    <th className="thead-item admin-cursor-pointer" onClick={() => handleSort('hotel')}>Hotel</th>
                    <th className="thead-item admin-cursor-pointer" onClick={() => handleSort('client')}>Client</th>
                    ...
                    <tr key={booking._id}>
                        ...
                        <td className="table-data">
                            <div className="table-buttons">
                                <Link to={`/host/update-hotel-booking/${booking._id}`}>
...
export default HostHotelBookingsTable;
