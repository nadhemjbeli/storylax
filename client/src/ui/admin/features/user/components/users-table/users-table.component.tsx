// src/ui/admin/features/user/components/users-table.component.tsx
...
import { ReactComponent as InterestsIcon } from '../../../../../../assets/svg/admin/heart.icon.svg';
...
const UserTable: React.FC<UserTableProps> = ({ users, onDelete, itemsPerPage = 10 }) => {
    ...
    return (
        <div className="admin-table-container">
                    ...
                    <tr key={user._id} className="admin-table-row">
                        ...
                        <td className="admin-table-data">
                            <div className="admin-table-buttons">
                                <Link to={`/admin/update-user-interests/${user._id}`}>
                                    <button className="admin-interests-button">
                                        <InterestsIcon className="admin-manage-icon" />
                                    </button>
                                </Link>
                                ...
                                <button className="admin-delete-button" onClick={() => handleDeleteClick(user)}>
            ...
            <ConfirmationModal
                ...
                element={selectedUser && `${selectedUser.firstName} ${selectedUser.lastName}` || 'user'}
            />
        </div>
    );
};
