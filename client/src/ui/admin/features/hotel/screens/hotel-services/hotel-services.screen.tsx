...
import HotelServicesTable from '../../components/hotel-services-table/hotel-services-table.component.tsx';
import {getHotelServicesByHotel, IHotel, IHotelService} from '../../../../../../data/hotel/hotel.data.ts';
...
const AdminHotelServicesComponent: React.FC<AdminHotelServicesComponentProps> = () => {
...
export default AdminHotelServicesComponent;
